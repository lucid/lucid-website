...
if(!dojo._hasResource["lucidsite.download"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["lucidsite.download"] = true;
dojo.provide("lucidsite.download");
...
dojo.i18n._preloadLocalizations("lucidsite.nls.download", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nl","nl-nl","no","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]);
